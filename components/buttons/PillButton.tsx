...
const PillButton = ({
  ...
  const getBackgroundColor = useCallback(
    (pressed: boolean): ThemeColor => {
      ...
      const { backgroundColor, backgroundColorPressed, backgroundColorDisabled } = theme.pillVariants[variant];
  ...
  return (
    <Pressable
      ...
      onPress={onPress}
      paddingVertical="height-height-xs"
      paddingHorizontal="3-5"
      paddingRight={dismissable ? "2" : "3-5"}
      flexDirection="row"
